...
namespace TypeClassMapperSpec
{
  ...
  public class QueryMappingCases
  {
    ...
    {
      //Arrange
      utility.ITypeClassMapper typemap = new utility.TypeClassMapper(new Dictionary<string, string> { { "app1.ISource", "module1.Source, TypeClassMapperSpec" } });
      ...
      string mapped_found = typemap.Mappings.FirstOrDefault(mapping => mapping.Key == "app1.ISource").Value;
      string mapped_notfound = typemap.Mappings.FirstOrDefault(mapping => mapping.Key == "none.ISome").Value;
